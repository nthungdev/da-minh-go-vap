...
export default function AppSelectBasic(props: AppSelectBasicProps) {
  ...
  const data = {
    ...
    toggleClasses:
      `hs-select-disabled:pointer-events-none hs-select-disabled:opacity-50 relative py-3 ps-4 pe-9 flex flex-row justify-center gap-x-2 text-nowrap w-full cursor-pointer bg-white border border-gray-200 rounded-lg text-center text-sm focus:outline-none focus:ring-2 focus:ring-blue-500`,
    dropdownClasses:
