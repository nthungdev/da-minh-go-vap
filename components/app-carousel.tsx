...
interface AppCarouselProps extends React.HTMLAttributes<HTMLDivElement> {
...
export default function AppCarousel(props: AppCarouselProps) {
  const { children, onNext, onPrev, ...otherProps } = props
  ...
  return (
    <div
      {...otherProps}
      data-hs-carousel={JSON.stringify(hsCarouselData)}
